 ...
 * topic with no entry falls back to the English its own module declares, so
...
export const wiki = {
  ...
  "wiki.not_found": "Not found",
  "wiki.breadcrumb": "Breadcrumb",
  "wiki.on_this_page": "On this page",
  "wiki.search": "Search the documentation",
  "wiki.previous": "Previous",
  "wiki.next": "Next",
  "wiki.back_to_app": "Back to the app",
  "wiki.back_to_overview": "Back to the overview",
  "wiki.sign_in": "Sign in",
  "wiki.open_app": "Open app",
  "wiki.optional": "optional",

  // The source picker in the header, and the one placeholder notice beside it.
  "wiki.pick_source": "Pick a source",
  "wiki.pick_source_hint": "The snippets below fill in with the key of the source you pick.",
  "wiki.picker_label": "Source these instructions are written for",
  "wiki.copy_snippet": "Copy snippet",
  "wiki.placeholder_badge": "Snippets show placeholder keys",
  "wiki.placeholder_line": "Snippets show placeholder keys.",
  "wiki.sign_in_to_fill": "Sign in to fill them in",
  "wiki.add_source_to_fill": "Add a source to fill them in",
  "wiki.search_placeholder": "Search workspaces, projects, sources",
  "wiki.search_sources": "Search sources",
  "wiki.your_sources": "Your sources",
  "wiki.no_matches": "Nothing matches “{query}”.",
  "wiki.clear_selection": "Clear: go back to placeholders",
  ...
  "wiki.callout_note": "Note",
  "wiki.callout_warning": "Heads up",
  "wiki.callout_caution": "Fails silently",

  "wiki.step": "Step {n}",
  "wiki.steps_one": "{count} step",
  "wiki.steps_other": "{count} steps",

  // The four sections of the contents, in the order it shows them. The literal
  // in `WIKI_SECTIONS` stays the identity; these are only what it is called.
  "wiki.section_getting_started": "Getting started",
  "wiki.section_install_guides": "Install guides",
  "wiki.section_how_it_works": "How firstrun works",
  "wiki.section_reference": "Reference",
   ...
   */
  "wiki.index_lede_before": "firstrun is",
  "wiki.index_lede_strong": "one self-hosted analytics backend for everything you ship.",
  ...
  "wiki.no_pages": "No pages yet",
  "wiki.no_pages_hint": "The wiki has no topics registered. Pages live in",

  // One topic page.
  "wiki.kind_sources": "{kind} sources",
  "wiki.kind_mismatch":
  ...
  "wiki.no_page_called": "No page called “{slug}”",
  "wiki.not_found_hint":
    "It may have been renamed. Everything the wiki has is in the contents, and on the overview.",

  // The pages, by slug. Navigation, not prose: see the note at the top.
  "wiki.topic_what_is_firstrun_title": "What firstrun is",
  "wiki.topic_what_is_firstrun_summary":
    "One structured log for every surface you ship, on your own Postgres.",
  "wiki.topic_workspaces_title": "Workspaces, projects and sources",
  "wiki.topic_workspaces_summary": "The three levels, the two roles, and who can change what.",
  "wiki.topic_identity_title": "Identity",
  "wiki.topic_identity_summary":
    "Two fields, nothing inferred, and why a unique is only ever counted inside one surface.",
  "wiki.topic_querying_title": "Querying",
  "wiki.topic_querying_summary":
    "Filter, group, aggregate, bucket, limit: the whole vocabulary a card is built from.",
  "wiki.topic_dashboards_title": "Boards and cards",
  ...
  "wiki.topic_install_script_summary": "Two lines in the head. No build step and no package.",
  "wiki.topic_install_react_title": "React",
  "wiki.topic_install_react_summary": "React, Vite and Remix. One component, mounted once.",
  ...
  "wiki.topic_install_sveltekit_summary": "One call in the root layout, inside onMount.",
  ...
  "wiki.topic_install_python_summary": "Python 3.9+, standard library only, safe across a fork.",
  ...
  "wiki.topic_troubleshooting_title": "Troubleshooting",
  "wiki.topic_troubleshooting_summary":
    "Nothing arriving, entries arriving late, and uniques that look wrong.",
  "wiki.topic_log_entries_title": "Log entry reference",
  "wiki.topic_log_entries_summary":
    "One row shape for errors, events and measurements, and the conventions we suggest.",
  "wiki.topic_privacy_title": "Privacy and consent",
  "wiki.topic_privacy_summary":
    "What is collected, what happens before consent, and where the data lives.",
} satisfies Namespaced<"wiki">;

export type WikiMessages = typeof wiki;

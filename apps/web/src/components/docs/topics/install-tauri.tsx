 ...
 * "the events survive a kill" is what makes a desktop number trustworthy.
 */
...
export const topics: DocsTopic[] = [
  {
    ...
    render: (ctx) => (
      <DocsProse>
        <p>
          Every call hands an event to a background worker and returns: nothing panics into your
        ...
        <Snippet
          ...
          note={
            <>
              ...
              attributes. Values go on the wire as JSON, so a number stays a number, and an event
        ...
        <Callout title="The queue is on disk">
          Events are appended to an NDJSON file beside the anonymous id before they go anywhere
          else, bounded at 5,000 events and 2 MB, dropping the oldest and counting them in{" "}

...
/**
 * Who this wiki is currently written for.
 *
 ...
 */
function groupSources(sources: WikiSource[]): WorkspaceNode[] {
...
export function SourcePicker(props: {
  ...
  const choose = (source: WikiSource | null) => {
      ...
      <Show when={props.sources.length > 0} fallback={<EmptyPicker signedIn={props.signedIn} />}>
        ...
        >
          ...
          >
            ...
            <div class="flex h-[45px] items-center gap-2.5 border-b py-0.5">
              <div class="relative min-w-0 flex-1">
                ...
                <Input
                  ...
                  onKeyDown={onKeyDown}
                  placeholder={i18n.t("wiki.search_placeholder")}
                  aria-label={i18n.t("wiki.search_sources")}
            ...
            <ScrollArea role="tree" aria-label={i18n.t("wiki.your_sources")} class="max-h-72 p-1">
              <Show
                when={tree().length > 0}
                fallback={
                  ...
                  <div class="grid min-h-[196px] place-items-center px-4 text-body text-muted-foreground">
                    ...
                    {i18n.t("wiki.no_matches", { query: query().trim() })}
                  </div>
                }
              >
                <For each={tree()}>

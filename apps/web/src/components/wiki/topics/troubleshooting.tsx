...
export const topics: WikiTopic[] = [
  {
    ...
    summary: "Nothing arriving, entries arriving late, and uniques that look wrong.",
      ...
      <WikiProse>
        ...
        <ul>
          ...
          <li>
            ...
            and an app with entries is usually this.
          </li>
        </ul>

        <h2>Entries arrive late</h2>
        <ul>
          <li>
            <code>time</code> is stamped by the client and is what every chart buckets on. An
            entry that reaches us on Friday and happened on Tuesday is counted on Tuesday.
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>An attribute nobody writes.</strong> Grouping or filtering on a key no entry
          ...
          <li>
            ...
            An entry your logger calls <code>warning</code> is 13 and is outside it.
          </li>
          <li>

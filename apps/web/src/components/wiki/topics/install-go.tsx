...
export const topics: WikiTopic[] = [
  {
    ...
    render: (ctx) => (
      <WikiProse>
        <p>
          Every call puts an entry on a bounded channel and returns, taking no lock a request path
        ...
        <Callout title="DistinctID is yours to supply">
          ...
          so pass an id you already have per call. An entry without one is{" "}

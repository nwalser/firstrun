...
const PARTS: Array<{ part: string; what: string }> = [
  ...
  },
  {
    part: "Aggregate",
    what:
      "Entries, uniques, or a numeric aggregate over an attribute: sum, average or a percentile.",
  },
  {
    part: "Time bucket",
...
const EXAMPLES: Array<{ question: string; query: string }> = [
  {
    ...
    query: "severity at least ERROR · bucket by day · count entries",
  },
  {
  ...
  },
  {
    ...
    query: "name is exception · group by service.version and exception.type · count entries",
  },
];

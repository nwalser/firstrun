    ...
    render: () => (
      <WikiProse>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>The client, on every entry</TableCell>
              <TableCell>
        ...
        <p>
          ...
          other. A project is a namespace for entries, sources and boards; it is not an identity
        ...
        <p>
          ...
          rather than something reconstructed from behaviour. It applies to the entries that carry
        ...
        <h2>Late entries count when they happened</h2>
        <p>
          ...
          as Friday. Every series and every bucket is built on that, never on when the entry
          arrived.
        </p>
      </WikiProse>
    ),

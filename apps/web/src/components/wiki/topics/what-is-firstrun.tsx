 ...
 *
 * Deliberately the shortest page in the wiki. Somebody deciding in ninety
    ...
    render: (ctx) => (
      <WikiProse>
        ...
        <p>
          ...
          grouped and aggregated exactly like <code>os.type</code>. An entry is never rejected for
        ...
        <p>
          ...
          fire-and-forget and bounded: it is allowed to lose entries, and it is not allowed to

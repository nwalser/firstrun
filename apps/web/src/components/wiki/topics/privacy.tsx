    ...
    render: (ctx) => (
      <WikiProse>
        ...
        <p>
          ...
          own Postgres. Entries go to <code>{ctx.vars.origin}</code> and nowhere else. There is no
        ...
        <ul>
          ...
          <li>
            <strong>From an app or a server:</strong> the entries that software writes, plus
          ...
          <li>
            ...
            <code>identify()</code> call. An error entry carries the exception type, message and
            stack you hand it.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            <Link to="/wiki/$topic" params={{ topic: "identity" }}>
              Identity
            </Link>
            .
          </li>
